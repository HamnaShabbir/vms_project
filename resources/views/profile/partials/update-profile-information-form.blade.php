<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input type="file" class="dropify" id="create_image{{ $user->id }}" name="profile_picture"
                data-allowed-file-extensions="png jpg jpeg svg bmp" data-height="119" autocomplete="off"
                @if ($user->profile_picture) data-default-file="{{ $user->profile_image_url }}" @endif>

            <!-- Hidden input to send existing image URL -->
