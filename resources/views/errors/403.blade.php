    ...
    <section class="error section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <img src="{{ asset('assets/dist/img/error/403.jpg') }}" alt="" class="img-fluid">
                </div>
                <div class="col-lg-5">
                    <div class="error-content mt-5 mt-lg-0">
                        <h3>Access Denied!</h3>
                        <p class="mt-3">The page you are trying to reach i s absolutely forbidden for some reason</p>
