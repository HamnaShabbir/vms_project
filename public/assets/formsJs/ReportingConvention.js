...
function CallDatatable() {
    ...
    $("#result").DataTable({
        ...
        columns: [
            ...
            { data: 'reporting_convention', name: 'reporting_convention' },
...
$('body').delegate(".edit_row", 'click', function () {
    ...
    $.post(edit_url, {
        ...
        $('#edit_reporting_convention').val(res.reporting_convention)
    })
    ...
    $.post(trashed_data_url, {
        ...
        $("#trashed_data_result").DataTable({
            ...
            columns: [
                { data: 'id', name: 'id' },
                {
                    data: 'framework_id', name: 'framework_id', render: function (data, full, row, met) {
                    return row.get_frame_work.title;
                    }
                },
                { data: 'reporting_convention', name: 'reporting_convention' },
                { data: 'created_at', name: 'created_at' },
