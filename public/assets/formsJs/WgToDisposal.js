...
function CallDatatable() {
    ...
    $("#result").DataTable({
        ...
        columns: [
            ...
            { data:'wd_to_disposal',name:'wd_to_disposal'},
            { data:'dm_id',name:'dm_id'},
            { data:'onsite',name:'onsite'},
            { data:'offsite',name:'offsite'},
...
$('body').delegate(".edit_row", 'click', function () {
    ...
    $.post(edit_url, {
        ...
        $('#edit_wd_to_disposal').val(res.wd_to_disposal);
        $('#edit_onsite').val(res.onsite);
        $('#edit_offsite').val(res.offsite);
        $('#edit_total').val(res.total);
        $('#edit_mu_id').val(res.mu_id);
        $('#edit_dm_id').val(res.dm_id);
    ...
    $.post(trashed_data_url, {
        ...
        $("#trashed_data_result").DataTable({
            ...
            columns: [
                ...
                {
                    data: 'dm_id', name: 'dm_id', render: function (data, full, row, met) {
                    return row.get_disposal_method.title;
                    }
                },
                { data:'wd_to_disposal',name:'wd_to_disposal'},
                { data:'onsite',name:'onsite'},
