...
function CallDatatable() {
    ...
    $("#result").DataTable({
        ...
        columns: [
            { data: 'id', name: 'id' },
            { data: 'sdg_id', name: 'sdg_id' },
            { data: 'importance_stakeholder', name: 'importance_stakeholder' },
            { data: 'impact_company', name: 'impact_company' },
...
$('body').delegate(".edit_row", 'click', function () {
    ...
    $.post(edit_url, {
        ...
        $('#id').val(res.id);
        $('#edit_sdg_id').val(res.sdg_id)
        $('#edit_importance_stakeholder').val(res.importance_stakeholder)
        $('#edit_impact_company').val(res.impact_company)
        $('#edit_score').val(res.score)
